...
public class RecipeBoardController {
	...
	public String registerRecipe(RecipeBoardVO recipeBoard,
			...
			@RequestParam(value = "ingredientNote", required = false) List<String> ingredientNotes) throws IOException {
		...
		if (stepDescriptions != null && !stepDescriptions.isEmpty()) {
			for (int i = 0; i < stepDescriptions.size(); i++) {
				...
				if (stepImages != null && i < stepImages.size() && stepImages.get(i) != null
