...
public interface RecipeBoardService {
    ...
    void createRecipeWithIngredients(RecipeBoardVO recipeBoard, List<Integer> ingredientIds, MultipartFile thumbnail);
    void updateRecipeWithIngredients(RecipeBoardVO recipeBoard, List<Integer> ingredientIds, MultipartFile thumbnail);
