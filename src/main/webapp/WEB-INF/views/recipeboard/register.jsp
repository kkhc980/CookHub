    ...
    document.getElementById("registerForm").addEventListener("submit", function (e) {
        ...
        request.onload = function () {
            if (request.status === 200) {
                ...
                window.location.href = this.action.replace("register", "list");
        ...
        }.bind(this); // 'this' 컨텍스트를 유지하기 위해 bind 사용
	...
	<form action="${pageContext.request.contextPath}/recipeboard/register"
		...
		<div class="form-group">
			<label for="thumbnail">썸네일 이미지</label> <input type="file"
				...
				onchange="validateAndPreviewThumbnail(this)">
			<div class="thumbnail-preview">
				<img id="thumbnailPreview" src="#" alt="Thumbnail Preview"
					style="display: none;">
			</div>
			<p id="noThumbnailMessage" class="noThumbnailMessage">No
			...
			<ul>
				...
				<c:forEach var="ingredient" items="${ingredientsList}">
					<c:if test="${ingredient.ingredientId != 1}">
						<li><input type="checkbox" name="ingredientIds"
		...
		<div class="recipe-info-container">
			<div class="form-group">
				<label for="time">시간</label> <select id="time" name="time" required>
			...
			<div class="form-group">
				<label for="difficulty">난이도</label> <select id="difficulty"
			...
			<div class="form-group">
				<label for="servings">인분</label> <select id="servings"
